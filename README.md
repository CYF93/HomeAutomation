...
Code Summary:<br>
1.) IR_receive.py: CircuitPython code to receive any remote control button signal and print it. After running the code, aim remote control at the IR receiver and press the button. 
